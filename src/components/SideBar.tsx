    ...
    return(
      <div className="border-l-[2px] border-[#D1D1D1] h-100 py-5 col-span-1">
        <div className="px-5 grid grid-cols-2 gap-4">
          <button className="text-[#DC4A2D] bg-[#FEF4F2] p-2 font-normal flex col-span-1 rounded-[8px] justify-center border-[1px] border-[#DC4A2D] items-center"><Trash2 className="w-4 mr-1"/>Delete job</button>
          <button className="text-[#FEF4F2] bg-[#DC4A2D] p-2 font-normal flex col-span-1 rounded-[8px] justify-center border-[2px] border-[#FED3CA] items-center"><Pencil className="w-4 mr-1"/>Edit Job</button>
